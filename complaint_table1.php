            ...
            <div class="row">
                <div class="col-md-12 lead">
                    ...
                    <div class="search-container">
                     <input type="text" placeholder="Search with Date.." name="search" id="searchInput" onkeyup="searchTable()">
...
<div style="margin-left:0px;padding-top:30px;" id="show_table">
...
function searchTable() {
  ...
  tr = table.getElementsByTagCreatedDate("tr");

console.log(filter)

  for (i = 0; i < tr.length; i++) {
    td = tr[i].getElementsByTagCreatedDate("td")[2];
    console.log(td)
    if (td) {
        ...
        getapi(url);
         ...
         function show(data) {
            ...
            <div style=" display: flex;justify-content: space-around;">
                    ...
                    <button style="border-width:2px;border-color:black;padding:4px;margin-left:5px;" onclick="give_response(${r.id})">Response</button>   

              <button style="border-width:2px;border-color:black; margin-left:20px; padding:4px;" data-toggle="modal" onclick="viewDetails(${r.id})">View</button>
             </div>
             </td>

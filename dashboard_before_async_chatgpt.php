                                   ...
                                   <div class="col-lg-3 mb-2">
                                    <div class="card bg-stone-500 text-black shadow">
                                        <div class="card-body">
                                            ...
                                            <input type="text" id="income_total" >
                                            <div class="text-white-50 small"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 mb-2">
                                    <div class="card bg-white text-black shadow" >
                                        <div class="card-body">
                                            ...
                                            <input type="text" id="expenditure_total" >
                                            <div class="text-white-50 small"></div>
                                        </div>
                                    </div>
                                </div>
   ...
   "building_name":buidling_name
    ...
    async function search1(data) 
    {
         ...
         document.getElementById("income").innerHTML = lab;
            ...
            var income1=data1[0]['Total income'];
   ...
   "building_name":buidling_name
    ...
    async function search_expenditure(data) 
    {
         ...
         document.getElementById("expenditure").innerHTML = lab;
            ...
            var expenditure1=total_expenditure[0]['Total Expenses'];
...
const get_total_complaints="https://iqbetspro.com/pg-management/total-no-of-complaints.php";
  ...
  console.log("solved=", document.getElementById("Solved").value);
  console.log("pending=", document.getElementById("Pending").value);
         
        //        
//         updateChartData(solved1, pending1);
        
// show_accounts_complaints();
...
console.log("solved before pie chart =",solved1);
console.log("penidng=",solved1);

// const data222 = {'Total Complaints': 22, 'Solved Complaints': '4', 'Pending Complaints': '18'};

// const totalComplaints = parseInt(data222['Total Complaints']);
// const solvedComplaints = parseInt(data222['Solved Complaints']);
// const pendingComplaints = parseInt(data222['Pending Complaints']);

// console.log("tc",totalComplaints); // output: 22
// console.log("ts",solvedComplaints); // output: 4
// console.log("pc",pendingComplaints); // output: 18
...
// const data_income = document.getElementById("income_total");
const data_income = document.getElementById("income_total").innerHTML;
//alert("dc=",data_income);

const income_total = parseInt(data_income['Total income']);


console.log("inc total",income_total); // output: 22
 // output: 4
 // output: 18


const data_expenditure=document.getElementById("expenditure_total").value;
const expenditure_total = parseInt(data_expenditure['Total Expenses']);
console.log("expenditure_total=",expenditure_total);
